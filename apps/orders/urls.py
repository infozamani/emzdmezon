...
urlpatterns = [
    ...
    path('status-of-shop-cart/', status_of_shop_cart, name='status-of-shop-cart'),
    path('status-of-favorites/', status_of_favorites, name='status-of-favorites'),
    path('status-of-compare/', status_of_compare, name='status-of-compare'),
]