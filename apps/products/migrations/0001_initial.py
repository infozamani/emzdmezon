# Generated by Django 5.0.3 on 2024-06-25 11:52
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('feature', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='featuer_value', to='products.feature', verbose_name='ویژگی')),
            ],
            options={
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('filter_value', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='products.featuervalue', verbose_name='مقدار ویژگی برای فیلتر')),
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='product_featuers', to='products.product', verbose_name='کالا')),
            ],
            options={
